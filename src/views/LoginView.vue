...
export default {
  setup() {
    ...
    const vertify = () => {
      ...
      console.log(state.emptyEmailError)
    }
    const login = () => {
      vertify()
      let obj = {
    ...
    <div class="container mx-auto md:px-[100px] lg:flex">
      ...
      <section class="mx-auto w-[80%] lg:mt-20 lg:w-[40%]">
        ...
        <form class="form mt-10">
          ...
          <h2
            class="mb-2 mt-6 text-lg font-normal after:ml-0.5 after:text-red-500 after:content-['*']"
          >
            Password
          </h2>
          <input
            class="mb-4 w-full rounded-xl py-3 px-4"
            type="password"
            name=""
            id="pwd"
            placeholder="請輸入密碼"
        ...
        <div class="mt-6 flex justify-center">
          <button
            v-on:click="login"
            class="sign_in w-[128px] rounded-lg bg-black py-3 text-[16px] text-white"
          >
            登入
          </button>
        </div>
